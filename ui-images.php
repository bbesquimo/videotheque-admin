               ...
               <div class="iq-card">
                  ...
                  <div class="iq-card-body">
                     ...
                     <div class="media mb-5">
                        ...
                        <img src="../assets/images/page-img/18.jpg" class="ml-3 avatar-80" alt="#">
                     </div>
                     <div class="media mb-5">
                        <div class="media-body">
                        ...
                        <img src="../assets/images/page-img/19.jpg" class="align-self-center avatar-80 mr-3" alt="#">
                     </div>
                     <div class="media">
                        <div class="media-body">
                        ...
                        <img src="../assets/images/page-img/20.jpg" class="align-self-end avatar-80 mr-3" alt="#">
                     </div>
                  </div>
               </div>
            </div>
            <div class="col-sm-12 col-lg-6">
               <div class="iq-card">
                  ...
                  <div class="iq-card-body">
                     ...
                     <img src="../assets/images/page-img/12.jpg" class="rounded ml-3" alt="Responsive image">
                  </div>
               </div>
               <div class="iq-card">
                  <div class="iq-card-header d-flex justify-content-between">
               ...
               <div class="iq-card">
                  ...
                  <div class="iq-card-body">
                     ...
                     <div class="media mb-4">
                        <img src="../assets/images/page-img/21.jpg" class="align-self-start avatar-80 mr-3" alt="#">
                        <div class="media-body">
                     ...
                     <div class="media mb-4">
                        <img src="../assets/images/page-img/22.jpg" class="align-self-center avatar-80 mr-3" alt="#">
                        <div class="media-body">
                     ...
                     <div class="media">
                        <img src="../assets/images/page-img/23.jpg" class="align-self-end avatar-80 mr-3" alt="#">
                        <div class="media-body">
